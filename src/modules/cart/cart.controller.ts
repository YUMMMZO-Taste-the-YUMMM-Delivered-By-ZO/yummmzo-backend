...
/**
    ...
    * GET /api/v1/cart
*/
export const getCartController = catchAsync(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
*/
export const addCartItemController = catchAsync(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
*/
export const updateCartItemController = catchAsync(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
*/
export const removeCartItemController = catchAsync(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
/**
    ...
    * DELETE /api/v1/cart
*/
export const clearCartController = catchAsync(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
